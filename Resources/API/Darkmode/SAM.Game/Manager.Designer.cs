...
namespace SAM.Game
{
    ...
    {
        private Color normalColor = ColorTranslator.FromHtml("#1c1c1c");
        private Color hoverColor = ColorTranslator.FromHtml("#2c2c2c"); // Change this color as needed
	...
	partial class Manager
	{
        ...
        public static class DwmApi
        {
            ...
            public const int DWMWA_USE_IMMERSIVE_DARK_MODE = 20; // for Windows 10 version 1809 and above
		...
		private void InitializeComponent()
		{
            ...
            this._MainToolStrip.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            ...
            this._StoreButton.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            this._StoreButton.ForeColor = System.Drawing.Color.White;
            // 
            ...
            this._ReloadButton.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            ...
            this._ResetButton.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            ...
            this._MainStatusStrip.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            ...
            this._GameStatusLabel.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            this._GameStatusLabel.ForeColor = System.Drawing.Color.White;
            // 
            ...
            this._DownloadStatusLabel.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            ...
            this._AchievementsTabPage.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            // 
            // _AchievementListView > Achievement List
            // 
            this._AchievementListView.Activation = System.Windows.Forms.ItemActivation.OneClick;
            this._AchievementListView.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            ...
            this._AchievementsToolStrip.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            ...
            this._LockAllButton.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            this._LockAllButton.ForeColor = System.Drawing.Color.White;
            // 
            ...
            this._UnlockAllButton.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            this._UnlockAllButton.ForeColor = System.Drawing.Color.White;
            // 
            ...
            this._InvertAllButton.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            this._InvertAllButton.ForeColor = System.Drawing.Color.White;
            // 
            ...
            this._StatisticsTabPage.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            // 
            ...
            this._EnableStatsEditingCheckBox.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            ...
            this._StatisticsDataGridView.BackgroundColor = ColorTranslator.FromHtml("#1c1c1c");
            this._StatisticsDataGridView.EnableHeadersVisualStyles = false;
            this._StatisticsDataGridView.ColumnHeadersDefaultCellStyle.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            this._StatisticsDataGridView.ColumnHeadersDefaultCellStyle.ForeColor = System.Drawing.Color.White;
            this._StatisticsDataGridView.RowsDefaultCellStyle.BackColor = ColorTranslator.FromHtml("#1c1c1c");
            this._StatisticsDataGridView.RowsDefaultCellStyle.ForeColor = System.Drawing.Color.White;
            ...
            this.Name = "Manager";
            this.Text = "Steam Achievement Manager+ 0.9.4.1";
            ...
            this.PerformLayout();
            SetTitleBarColor("#1c1c1c");
		}
        private void SetTitleBarColor(string hexColor)
        {
            IntPtr hwnd = this.Handle;
            int color = ConvertColorToInt(hexColor);

            // Ensure to check if the OS version supports this attribute
            if (Environment.OSVersion.Version.Build >= 17763)
            {
                DwmApi.DwmSetWindowAttribute(hwnd, DwmApi.DWMWA_CAPTION_COLOR, ref color, Marshal.SizeOf(color));
            }
        }
